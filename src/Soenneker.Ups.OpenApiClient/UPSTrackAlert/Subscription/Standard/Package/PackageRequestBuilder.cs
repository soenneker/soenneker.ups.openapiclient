...
using System;
namespace Soenneker.Ups.OpenApiClient.UPSTrackAlert.Subscription.Standard.Package
{
    /// <summary>
    /// Builds and executes requests for operations under \UPSTrackAlert\subscription\standard\package
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class PackageRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Ups.OpenApiClient.UPSTrackAlert.Subscription.Standard.Package.PackageRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PackageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/UPSTrackAlert/subscription/standard/package", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Ups.OpenApiClient.UPSTrackAlert.Subscription.Standard.Package.PackageRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PackageRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/UPSTrackAlert/subscription/standard/package", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Ups.OpenApiClient.UPSTrackAlert.Subscription.Standard.Package.PackageRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Ups.OpenApiClient.UPSTrackAlert.Subscription.Standard.Package.PackageRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Ups.OpenApiClient.UPSTrackAlert.Subscription.Standard.Package.PackageRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
