...
namespace Soenneker.Ups.OpenApiClient.Models
{
    ...
    public partial class TrackingActivity : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Ups.OpenApiClient.Models.TrackingActivity"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Ups.OpenApiClient.Models.TrackingActivity"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Ups.OpenApiClient.Models.TrackingActivity CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Ups.OpenApiClient.Models.TrackingActivity();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "location", n => { Location = n.GetObjectValue<global::Soenneker.Ups.OpenApiClient.Models.TrackingLocation>(global::Soenneker.Ups.OpenApiClient.Models.TrackingLocation.CreateFromDiscriminatorValue); } },
                { "logicalScan", n => { LogicalScan = n.GetBoolValue(); } },
                { "status", n => { Status = n.GetObjectValue<global::Soenneker.Ups.OpenApiClient.Models.TrackingStatus>(global::Soenneker.Ups.OpenApiClient.Models.TrackingStatus.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Ups.OpenApiClient.Models.TrackingLocation>("location", Location);
            writer.WriteBoolValue("logicalScan", LogicalScan);
            writer.WriteObjectValue<global::Soenneker.Ups.OpenApiClient.Models.TrackingStatus>("status", Status);
