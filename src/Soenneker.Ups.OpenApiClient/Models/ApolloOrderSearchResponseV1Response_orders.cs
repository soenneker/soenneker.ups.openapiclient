...
namespace Soenneker.Ups.OpenApiClient.Models
{
    ...
    public partial class ApolloOrderSearchResponseV1Response_orders : IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Ups.OpenApiClient.Models.ApolloOrderSearchResponseV1Response_orders_items? Items { get; set; }
#nullable restore
#else
        public global::Soenneker.Ups.OpenApiClient.Models.ApolloOrderSearchResponseV1Response_orders_items Items { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Ups.OpenApiClient.Models.ApolloOrderSearchResponseV1Response_orders"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Ups.OpenApiClient.Models.ApolloOrderSearchResponseV1Response_orders CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Ups.OpenApiClient.Models.ApolloOrderSearchResponseV1Response_orders();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "items", n => { Items = n.GetObjectValue<global::Soenneker.Ups.OpenApiClient.Models.ApolloOrderSearchResponseV1Response_orders_items>(global::Soenneker.Ups.OpenApiClient.Models.ApolloOrderSearchResponseV1Response_orders_items.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Ups.OpenApiClient.Models.ApolloOrderSearchResponseV1Response_orders_items>("items", Items);
