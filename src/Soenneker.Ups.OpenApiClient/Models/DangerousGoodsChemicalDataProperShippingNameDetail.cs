...
namespace Soenneker.Ups.OpenApiClient.Models
{
    ...
    public partial class DangerousGoodsChemicalDataProperShippingNameDetail : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
        ...
        /// </summary>
        public DangerousGoodsChemicalDataProperShippingNameDetail()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Ups.OpenApiClient.Models.DangerousGoodsChemicalDataProperShippingNameDetail"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Ups.OpenApiClient.Models.DangerousGoodsChemicalDataProperShippingNameDetail CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Ups.OpenApiClient.Models.DangerousGoodsChemicalDataProperShippingNameDetail();
        }
        /// <summary>
