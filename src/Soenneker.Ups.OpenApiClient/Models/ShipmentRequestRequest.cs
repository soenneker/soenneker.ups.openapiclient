...
namespace Soenneker.Ups.OpenApiClient.Models
{
    ...
    public partial class ShipmentRequestRequest : IAdditionalDataHolder, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Ups.OpenApiClient.Models.ShippingRequestTransactionReference? TransactionReference { get; set; }
#nullable restore
#else
        public global::Soenneker.Ups.OpenApiClient.Models.ShippingRequestTransactionReference TransactionReference { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Ups.OpenApiClient.Models.ShipmentRequestRequest"/> and sets the default values.
        /// </summary>
        public ShipmentRequestRequest()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Ups.OpenApiClient.Models.ShipmentRequestRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Ups.OpenApiClient.Models.ShipmentRequestRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Ups.OpenApiClient.Models.ShipmentRequestRequest();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "TransactionReference", n => { TransactionReference = n.GetObjectValue<global::Soenneker.Ups.OpenApiClient.Models.ShippingRequestTransactionReference>(global::Soenneker.Ups.OpenApiClient.Models.ShippingRequestTransactionReference.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Ups.OpenApiClient.Models.ShippingRequestTransactionReference>("TransactionReference", TransactionReference);
